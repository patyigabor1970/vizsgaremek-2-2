...
(1, 'Thermopylae', 20, '1. terem'),
(2, 'Dún Scáith', 10, '2. terem'),
(3, 'Avalon', 2, '3. terem');
...
(1, 'Mezei Gábor', '+36305110546', 'http://localhost:5173/src/images/mezeigabor.jpg','10 év kosárlabdázás után döntöttem a súlyzós edzés mellett, ami azóta már életformává vált. Éppen ezért döntöttem úgy,hogy edzői képesítést szerzek és bárki számára segítséget tudjak nyújtani, aki a súlyzós edzés világába szeretne betekintést nyerni.', 2),
...
(3, 'Sós Norbert', '+36301252244', 'http://localhost:5173/src/images/sosnorbert.jpg', 'Édesanyám sportrehabilitációs trénerként óriási mértékben hatott rám. Korábban számos sportágat kipróbáltam, míg végül 7 évvel ezelőtt elragadott az edzőtermek világa, ahol megtaláltam önmagam.  Az edzéselmélet mellett a táplálkozástudományban is elmélyedtem. ', 4),
(4, 'Vári Áron', '+363065630303', 'http://localhost:5173/src/images/variaron.jpg', 'Gyermekkorom óta életem meghatározó részévé vált a sport. Kezdetben kipróbáltam a karate különböző válfajait, majd belekóstoltam az atlétikába. Ezek a sportok kiváló alapot adtak fizikálisan, és mentálisan egyaránt.', 5);
